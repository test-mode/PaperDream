...
namespace PaperDream
{
    ...
    {
        private static readonly Color32 _color = new Color32(255, 255, 255, 255);
        ...
        private void OnParticleCollision(GameObject obj)
        {
            ...
            {
                int count = RainParticleSystem.GetCollisionEvents(obj, _collisionEvents);
                for (int i = 0; i < count; i++)
                {
                    ParticleCollisionEvent evt = _collisionEvents[i];
